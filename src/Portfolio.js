          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12 lg:mb-16">
            ...
            <div className="lg:col-span-1 order-2 lg:order-1">
              <div className="lg:sticky lg:top-32">
                <div className="w-full h-[32rem] sm:h-[36rem] lg:h-[36rem] bg-gradient-to-br from-slate-600 to-slate-500 rounded-2xl shadow-lg border-2 border-slate-500 flex items-center justify-center">
